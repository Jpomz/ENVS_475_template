...
**NOTE** When writing this tutorial I forgot that installing the `devtools` package can be a little tricky, and may require additional steps not described here. If you have trouble with the `install.packages("devtools")` command bellow, just skip it for now and read through the rest of the tutorial to get an idea of how it works. If many people have issues I will rewrite this section with an "easier installation" version and let you know when it's updated. 

**Sorry for any confusion!!** -- jpz
