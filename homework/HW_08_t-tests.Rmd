...
1.2 Use the `lm()` function to perform a 2-sample t-test on whether or not the average `blength` (in mm) is equal between the two years of data.  
  + Make sure to save your model-fit as an object, and then use the `summary()` function to print out the results.  
  
1.3 Add a comment to your script interpreting the results of your analysis.  
