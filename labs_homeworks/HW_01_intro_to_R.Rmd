...
Other options include *camelCase* where no spaces or separators are used but new words are capitalized (for example: `myDataObject`, `filteredData`, etc.), or using `.` to separate words (`my.data.object`, `filtered.data`. 
